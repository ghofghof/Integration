 ...
 */
class getReserverEventRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReserverEventRepository' shared autowired service.
     *
     * @return \App\Repository\ReserverEventRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReserverEventRepository.php';

        return $container->privates['App\\Repository\\ReserverEventRepository'] = new \App\Repository\ReserverEventRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
